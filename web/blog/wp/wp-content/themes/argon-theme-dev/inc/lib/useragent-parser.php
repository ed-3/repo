...
//图标
$GLOBALS['UA_ICON']['Chrome'] = $GLOBALS['UA_ICON']['Chrome OS'] = '<img src="https://cdn.jsdelivr.net/gh/ed-3/repo/web/resources/svg/browserIcons/Chrome.svg" width="20px" height="20px" />';
