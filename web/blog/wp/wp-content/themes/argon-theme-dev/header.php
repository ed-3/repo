...
<head>
	...
	<!--友链 css 模板-->
	<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/gh/ed-3/repo/web/resources/css/add-style.css">
	<!-- MDUI LIB-->
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/ed-3/repo/web/resources/UI_Lib/MDUI/css/mdui.min.css" />
...
<body <?php body_class(); ?>>
	...
	<div id="float_action_buttons" class="float-action-buttons fabtns-unloaded">
		...
		<button id="fabtn_toggle_darkmode" class="btn btn-icon btn-neutral fabtn shadow-sm" type="button" <?php if (get_option('argon_fab_show_darkmode_button') != 'true')
			...
			<span class="btn-inner--icon"><i class="fa fa-moon fa-moon-o"></i><i
					class='fa fa-lightbulb fa-lightbulb-o'></i></span>
		</button>
