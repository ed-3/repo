...
function shortcode_github($attr,$content=""){
	...
	$out .= "<div class='github-info-card-header'><a href='https://github.com/' ref='nofollow' target='_blank' title='Github' no-pjax><span><i class=\"fa fa-github-alt\" aria-hidden=\"true\"></i>>";
	if ($size != "mini"){
		$out .= " GitHub";
	}
	$out .= "</span></a></div>";
